	...
	<div class="semi-transparent-layer">
		<div class="topbar wrapper cf text-center ">
			...
			<div class="account-btns">
				<button class="btn btn-primary"><a href="/add">Write a novel</a></button>
				<button class="btn btn-secondary"><a href="">Log in</a></button>
			</div>
		</div> 

		<div class="slogan-container">
			<h1 class="main-header-title">Share your stories with the world</h1>
